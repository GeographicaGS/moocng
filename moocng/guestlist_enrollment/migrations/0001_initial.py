...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseGuestList'
        db.create_table('guestlist_enrollment_courseguestlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='i', max_length=10)),
        ))
        db.send_create_signal('guestlist_enrollment', ['CourseGuestList'])


    def backwards(self, orm):
        # Deleting model 'CourseGuestList'
        db.delete_table('guestlist_enrollment_courseguestlist')
